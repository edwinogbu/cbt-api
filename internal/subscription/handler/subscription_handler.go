...
// // @Failure      404  {object}  map[string]interface{}
// // @Security     BearerAuth
// // @Router       /api/v1/auth/subscription/check [get]
// func (h *SubscriptionCheckHandler) CheckSubscription(c *gin.Context) {
...
//     response, err := h.authService.CheckSubscription(userID)
//     if err != nil {
//         c.JSON(http.StatusNotFound, gin.H{"error": err.Error()})
//         return
//     }
