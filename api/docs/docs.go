    ...
    "paths": {
        ...
        "/auth/2fa/generate": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (TwoFactorResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/forgot-password": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message (always same for security)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (LoginResponse or 2FA_REQUIRED)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/refresh": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (TokenResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/register": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "message + data (LoginResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Reset details (email, code, new_password)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/send-otp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "OTP request (email, type)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/sessions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "data (list of sessions)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/class-arms": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Class arm details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateClassArmRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateClassArmRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/class-levels": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Class level details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateClassLevelRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateClassLevelRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/exams/practice/{studentId}/{subjectId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "data contains PracticeSessionResponse",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/exams/save-answer": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Save answer request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SaveAnswerRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "data contains SaveAnswerResponse",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/exams/start": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Start exam request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.StartExamRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "data contains StartExamResponse",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/exams/submit": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Submit exam request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SubmitExamRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "data contains SubmitExamResponse",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/health": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, message, timestamp",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/questions/bulk-delete": {
            "post": {
                ...
                "description": "Permanently delete a list of questions by their IDs",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BulkDeleteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/questions/create": {
            "post": {
                ...
                "description": "Add a question to the bank (supports multiple types, options, tags)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "201": {
                        "description": "data contains QuestionBankResponse",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/questions/filter": {
            "post": {
                ...
                "description": "Filter questions by subject, topic, difficulty, bloom level, type, tags, etc.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.FilterQuestionsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/questions/list": {
            "get": {
                ...
                "description": "Get paginated list of questions for a subject",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/questions/statistics": {
            "get": {
                ...
                "description": "Retrieve statistics about questions (total, by difficulty, bloom level, etc.) optionally filtered by subject.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Subject UUID (optional)",
                        "name": "subject_id",
                        "in": "query"
                    }
                ],
        ...
        "/questions/tags/create": {
            "post": {
                ...
                "description": "Add a tag that can be used to categorise questions.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "description": "Tag name and description",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "data contains TagResponse",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/questions/tags/list": {
            "get": {
                ...
                "description": "Get a list of all tags and their usage counts.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/questions/update/{id}": {
            "put": {
                ...
                "description": "Modify an existing question's fields (only provided fields are updated)",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        "description": "data contains updated QuestionBankResponse",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/school-session-classes/{schoolId}/{sessionId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/school-sessions/{schoolId}/current": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/session-terms/{sessionId}/current": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/subscriptions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (array of SubscriptionResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "message + data (CreateSubscriptionResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/subscriptions/payment-intent/{id}/confirm": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/subscriptions/school/{schoolId}/current": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "message + data (SubscriptionResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/subscriptions/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Verification details (reference, gateway)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/subscriptions/{id}/invoices": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (array of InvoiceResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/subscriptions/{id}/payment-intent": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Payment intent options (success/cancel URLs)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (PaymentIntentResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/subscriptions/{id}/transactions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (array of PaymentTransactionResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/subscriptions/{id}/usage": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "message + data (SubscriptionUsageResponse)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/webhook/{gateway}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Gateway name: stripe, paystack, flutterwave",
                        "name": "gateway",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "dto.CreateSchoolRequest": {
            ...
            "properties": {
                ...
                "code": {
                    "description": "changed: required → omitempty",
                    "type": "string",
                    "maxLength": 50,
                    "minLength": 2
                },
